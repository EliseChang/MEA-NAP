...
rawData = fullfile(HomeDir, 'organoids', 'Feb2024DIV250Stim');  % path to raw data .mat files
...
xlRange = 'A14:C17'; % specify range on the sheet (e.g., 'A2:C7' would analyse the first 6 files)
